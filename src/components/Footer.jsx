  ...
  return (
    ...
    >
        <Layout className='py-8 flex items-center justify-between lg:flex-col lg:py-6'>
           ...
           <div className='flex items-center lg:py-2 lg:text-sm'>
            Built with <span className='text-red-500 text-2xl px-1'>&#9825;</span> by &nbsp; <Link href='/about' className='underline underline-offset-2'>Ritesh Pradhan</Link>
           </div>
